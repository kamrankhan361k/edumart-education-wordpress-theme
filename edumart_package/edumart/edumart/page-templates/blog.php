...
<div class="inner-banner blog">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="content">
                    <h1><?php if(isset($edumart_redux_demo['blog_title'])){?>
                    <?php echo wp_specialchars_decode(esc_attr($edumart_redux_demo['blog_title']));?>
                    <?php }else{?>
                    <?php echo esc_html__( 'Blog', 'edumart' ); } ?></h1>
        ...
        <div class="col-sm-8 blog-left">
            <ul class="blog-listing">
                ...
                <li> 
                    ...
                    <a href="<?php the_permalink();?>"><img src="<?php echo wp_get_attachment_url(get_post_thumbnail_id());?>" class="img-responsive" alt=""></a>
                    <?php } ?>
