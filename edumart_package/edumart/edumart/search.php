...
<div class="inner-banner blog">
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <div class="content">
                    <h1><?php printf( esc_html__( 'Search Results for: %s', 'edumart' ), get_search_query() ); ?></h1>
        ...
        <div class="col-sm-8 blog-left">
            <ul class="blog-listing">
                ...
                <div class="single-news one-item horizontal-news">
                    <div class="search-custom search-no-result">
                        <h4><?php
                        // If no content, include the "No posts found" template.
                        echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'edumart' ) ;?> 
                        </h4>
                        <?php get_search_form();  ?>
                    </div>
                </div>
